...
faqSchema:
  - question: "Quanto custa um caça-vazamento em SJC?"
    answer: "O valor médio para detecção eletrônica de vazamentos em São José dos Campos varia entre R$ 350 e R$ 600, dependendo da complexidade e se é necessário emitir laudo técnico para a Sabesp ou condomínio."
...
O cenário é clássico em **São José dos Campos**: depois de um fim de semana de chuvas fortes de verão, você acorda na segunda-feira e nota aquela mancha escura crescendo no teto do banheiro. Ou pior: chega do trabalho e encontra a cozinha alagada por um flexível que estourou.
...
2. [Caça-Vazamentos e Tecnologia](#caça-vazamentos-a-tecnologia-que-evita-o-quebra-quebra)
3. [Diagnóstico por Bairro (Aquarius, Centro, Urbanova)](#diagnóstico-por-bairro-os-problemas-mais-comuns-em-sjc)
4. [Tabela de Preços e Valores 2026](#quanto-custa-um-encanador-de-emergência-em-sjc-estimativas-2026)
5. [Como Contratar com Segurança](#como-contratar-com-segurança)
6. [Perguntas Frequentes (FAQ)](#perguntas-frequentes-faq)

Neste guia, explicamos exatamente como agir nos primeiros 15 minutos de uma emergência hidráulica e como escolher o profissional certo para cada bairro de SJC.

## 🚨 O "Protocolo de 15 Minutos": O que fazer antes do Encanador chegar

Se a água está jorrando, cada segundo custa dinheiro. Siga este passo a passo imediato:

1.  **Feche o Registro Geral:**
    * **Em Apartamentos (Aquarius/Colinas):** Geralmente localizado na área de serviço ou nos shafts (tampas de visita) nos banheiros.
    * **Em Casas (Urbanova/Esplanada):** Vá direto ao hidrômetro (relógio de água) na calçada e feche a válvula principal.
2.  **Abra as Torneiras Mais Baixas:**
    * Se for uma casa sobrado, abra as torneiras do térreo ou do quintal. Isso "drena" a tubulação e diminui a pressão no ponto do vazamento.
3.  **Desligue a Eletricidade:**
    * Se a água estiver próxima a tomadas ou escorrendo por luminárias, desligue o disjuntor geral imediatamente para evitar curto-circuito.

> **Problemas elétricos após vazamento?** [Ver eletricistas verificados em SJC](/servicos/eletricista/) para reparos de curto-circuito e danos em fiação.

> **Dica de Ouro:** Se você mora em prédio antigo no **Centro** ou **Vila Adyana**, seus registros podem estar "emperrados" por falta de uso. Não force com alicate! Isso pode quebrar a borboleta e piorar a situação. Chame um profissional.

---

## 🔍 Caça-Vazamentos: A Tecnologia que Evita o "Quebra-Quebra"

Antigamente, achar um vazamento significava quebrar a parede inteira até encontrar o cano furado. Hoje, os [encanadores verificados em SJC](/servicos/encanador/) utilizam tecnologia de ponta para localizar o problema com precisão cirúrgica:

### 1. Geofone Eletrônico
Ideal para vazamentos ocultos em **tubulações de pressão** (água que vem da rua). O aparelho amplifica o som do vazamento no solo ou parede, permitindo que o técnico saiba exatamente onde quebrar.

### 2. Câmera Termográfica
Perfeita para identificar **infiltrações silenciosas** (aquelas manchas que não pingam, mas estragam a pintura). Muito usada em apartamentos no **Jardim Aquarius**, onde a infiltração pode vir do vizinho de cima. A câmera mostra a diferença de temperatura causada pela umidade.

---

## 🏘️ Diagnóstico por Bairro: Os Problemas Mais Comuns em SJC

Nossa base de dados de chamados em 2025 revelou padrões específicos para cada região da cidade:
...
## 💰 Quanto custa um Encanador de Emergência em SJC? (Estimativas 2026)

Valores médios baseados em profissionais 4+ estrelas da região:

| Serviço | Preço Médio (Horário Comercial) | Preço Médio (Emergência/24h) |
| :--- | :--- | :--- |
| **Visita Técnica** | R$ 80 - R$ 150 | R$ 200 - R$ 350 |
| **Caça-Vazamentos (com Laudo)** | R$ 350 - R$ 600 | R$ 500 - R$ 900 |
...
## 🛠️ Como Contratar com Segurança

Não chame o primeiro número que encontrar em um poste. A segurança da sua casa depende de quem você deixa entrar.

1.  **Exija Referências:** No **Serviços Urgentes**, todos os [encanadores listados](/servicos/encanador/) possuem verificação de antecedentes e avaliações reais.
2.  **Peça Garantia:** Pela lei, serviços têm garantia de 90 dias. Profissionais sérios colocam isso no recibo.
...
* [Vazamento no teto em SJC — guia de emergência →](/emergencias/vazamento-no-teto-sjc/)
...
<details>
<summary><strong>Quanto custa um caça-vazamento em SJC?</strong></summary>
**Resposta:** O valor médio para detecção eletrônica de vazamentos em São José dos Campos varia entre R$ 350 e R$ 600, dependendo da complexidade e se é necessário emitir laudo técnico para a Sabesp ou condomínio.
</details>

<details>
<summary><strong>O seguro residencial cobre encanador?</strong></summary>
**Resposta:** A maioria das assistências 24h de seguros cobre a "mão de obra emergencial" para conter o vazamento (ex: fechar o cano furado). O reparo estético (quebrar parede, colocar azulejo novo) geralmente não está coberto nas apólices básicas.
</details>
